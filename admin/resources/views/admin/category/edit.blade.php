      ...
      <div class="border-bottom row mb-3">
        <div class="col-sm-10">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a href="{{ route('category') }}">Relation</a>
            </li>
      		...
      		<div class="form-row">
      			<div class="col-md-12 mb-3">
      				<div class="form-group">
      					...
      					<input name="name" type="text" class="form-control" id="name" value="{{$result->title}}" autocomplete="off" placeholder="{{__('Label.Please Enter Category')}}">
      				</div>
      			</div>
      		</div>
      		<div class="form-row">
            ...
            <div class="col-md-6"> 
              <div class="form-group">
                <div class="custom-file ml-5"> 
                  <?php 
                    if ($result->image){
                      $app = Get_Image('category',$result->image);
                    } else{
                      $app = asset('assets/imgs/1.png');
                    }
                  ?>
                  <img  src="{{$app}}" height="120px" width="120px" class="img-thumbnail" id="preview-image-before-upload">
