...
@section('content')
    ...
    <div class="body-content">
      <!-- mobile title -->
      <h1 class="page-title-sm">Relation</h1>
      ...
      <div class="border-bottom row mb-3">
        ...
        <div class="col-sm-2 d-flex align-items-center justify-content-end" style="margin-top:-14px">
          <a href="{{ route('categoryAdd') }}" class="btn btn-default mw-120">Add Relation</a>
        </div>
      </div>
      ...
      $(function () {
        var table = $('.category-table').DataTable({
          ...
          "render": function (data, type, full, meta) {
            if(data){
                return "<img src='{{Get_Image('category')}}" + data + "' height=50 width=50 class='img-thumbnail'>";
              } else {
