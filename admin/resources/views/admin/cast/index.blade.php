    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            ...
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('castAdd') }}" class="btn btn-default mw-120" style="margin-top: -14px;">Add Doctor</a>
            </div>
        </div>
                ...
                var table = $('.cast-table').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, full, meta) {
                                if (data) {
                                    return (data.length > 130) ? data.substring(0, 130) +
                                        '...' : data;
                                } else {
                                    return "-";
                                }
                        ...
                        },
                        {
                            ...
                            name: 'availability',
                            "render": function(data, type, full, meta) {
                                if (full.availability_start && full.availability_end) {
                                    return full.availability_start + ' - ' + full
                                        .availability_end;
                                } else {
                                    return "-";
                                }
