    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            ...
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('cast') }}" class="btn btn-default mw-120" style="margin-top:-14px">DoctorDoctor</a>
            </div>
        </div>
            ...
            <form id="save_cast">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control" id="name"
                                placeholder="{{ __('Label.Please Enter Cast') }}" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="custom-file ml-5">
                                <img src="{{ asset('assets/imgs/1.png') }}" height="120px" width="120px"
                                    class="mb-3 img-thumbnail" id="preview-image-before-upload">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-top mt-2 pt-3 text-right">
                    <button type="button" class="btn btn-default mw-120"
                        onclick="save_cast()">{{ __('Label.SAVE') }}</button>
                </div>
            </form>
        </div>
    </div>
