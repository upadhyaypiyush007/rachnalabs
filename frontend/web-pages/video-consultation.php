    ...
    <style>
        ...
        * {
        ...
        .chat-bubble2 {
            ...
            width: 50px;
            height: 35px;
            animation: float 2s ease-in-out infinite 0.7s;
        }
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                   ...
                   <li class="nav-item">
                        <a class="nav-link active" href="video-consultation.php">Video Consultation</a>
                    </li>
                     <li class="nav-item">
...
<section class="hero-section">
    <div class="container">
        <div class="hero-content">
             <h1 class="hero-title">VIDEO CONSULATION</h1>
            <nav class="breadcrumb-custom">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                    <li class="breadcrumb-item active">Video Consultation</li>
                </ol>
            </nav>
        </div>
    </div>
  ...
  <div class="container-fluid">
        <div class="consultation-container" style="margin-top: 5%; margin-bottom:5%;">
            <div class="row g-0">
                <!-- Illustration Section -->
                <div class="col-lg-6">
                    <div class="illustration-section">
                        <div class="illustration">
                            ...
                            <div class="floating-elements">
                                ...
                                <div class="medical-cross">+</div>
                                <div class="medical-cross">+</div>
                                <div class="chat-bubble chat-bubble1"></div>
                                <div class="chat-bubble chat-bubble2"></div>
                            </div>
                            
                            <!-- Main Consultation Image -->
                            <img src="http://localhost/Pixelmax-Softech/Rachana-Healthcare/images/doctor/doc-pat.jpg" alt="Video Consultation" class="consultation-image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-section">
                        <h2 class="form-title">Video Consultation Form</h2>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <select class="form-select" required>
                                        ...
                                        <option value="dr-rohit-warrier">Dr. Rohit Warrier - Diabetologist</option>
                                        <option value="dr-kavita-kovi">Dr. Kavita Kovi - Gynecologist</option>
                                        <option value="dr-dinesh-manni">Dr. Dinesh Manni - Orthopedic Surgeon</option>
                                        <option value="dr-josna-ganesh">Dr. Josna Ganesh - General Medicine</option>
                                        <option value="dr-amit-sharma">Dr. Shiva Kumar A Naragel - ORTHOPEDICIAN</option>
                                        <option value="dr-priya-patel">Archana S - Senior Nutritionst, Certified Diabetest</option>
                                    </select>
                                </div>
                            </div>
 ...
 <footer class="footer-section">
    ...
    <script>
        ...
        document.getElementById('consultationForm').addEventListener('submit', function(e) {
            ...
            const doctor = this.querySelector('select').selectedOptions[0].text;
            
            // Show success message
            alert(`Thank you ${name}! Your video consultation request has been submitted. We will contact you soon to schedule your appointment with ${doctor}.`);
            
            // Reset form
            this.reset();
        });

        // Add floating animation to medical crosses
        document.addEventListener('DOMContentLoaded', function() {
            const crosses = document.querySelectorAll('.medical-cross');
            crosses.forEach((cross, index) => {
                cross.style.animationDelay = `${index * 0.5}s`;
            });
        });
    </script>
