...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <h1 class="hero-title">ECG</h1>
                <nav class="breadcrumb-custom">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="home.php">Home/ Services</a></li>
                        <li class="breadcrumb-item active">ECG</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <!-- About Section -->
    <img src="http://localhost/Pixelmax-Softech/Rachana-Healthcare/images/frame-ecg.png" class="image-used">

  <div class="main-container">
        <!-- An ECG can Help Detect Section -->
        <div class="section-header">An ECG can Help Detect :</div>
        <div class="content-section">
            <div class="condition-item">
                <span class="condition-name">Arrhythmias</span>
                <span class="condition-description"> - where the heart beats too slowly, too quickly, or irregularly.</span>
            </div>
            
            <div class="condition-item">
                <span class="condition-name">Coronary heart disease</span>
                <span class="condition-description"> - where the heart's blood supply is blocked or interrupted by a build-up of fatty substances.</span>
            </div>
            
            <div class="condition-item">
                <span class="condition-name">Heart attacks</span>
                <span class="condition-description"> - where the supply of blood to the heart is suddenly blocked.</span>
            </div>
            
            <div class="condition-item">
                <span class="condition-name">Cardiomyopathy</span>
                <span class="condition-description"> - where the heart walls become thickened or enlarged.</span>
            </div>
            
            <p>A series of ECGs can also be taken over time to monitor a person already diagnosed with a heart condition or taking medication known to potentially affect the heart.</p>
        </div>

        <!-- How an ECG is Carried Out Section -->
        <div class="section-header">How an ECG is Carried Out :</div>
        <div class="content-section">
            <p>There are several different ways an ECG can be carried out. Generally, the test involves attaching a number of small, sticky sensors called electrodes to your arms, legs and chest. These are connected by wires to an ECG recording machine. You don't need to do anything special to prepare for the test. You can eat and drink as normal beforehand.</p>
            
            <p>Before the electrodes are attached, you'll usually need to remove your upper clothing, and your chest may need to be shaved or cleaned. Once the electrodes are in place, you may be offered a hospital gown to cover yourself.</p>
            
            <p>The test itself usually only lasts a few minutes, and you should be able to go home soon afterwards or return to the ward if you're already staying in hospital.</p>
